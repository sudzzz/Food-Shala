...
$result = $mysqli->query("SELECT food_name,quantity,price from `checkout` WHERE cid='$cid' AND order_time='$time'") or die($mysqli->error);
$total = $mysqli->query("SELECT SUM(price) AS total FROM `checkout` WHERE cid='$cid' AND order_time='$time'");
