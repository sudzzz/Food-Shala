...
if(isset($_POST["submit"]))
{
  ...
  $qe = "SELECT * FROM `restaurant-register` where email = '$email'";
  ...
  $q = "SELECT * FROM `restaurant-register` where email = '$email' and password = '$password' ";   //Select the given row with entered email and password
